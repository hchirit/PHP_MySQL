 ...
 * tableau $_POST. 
 * 
 * @param	integer	$_GET['x']	Clé de l'article à commenter - crypté
 */
//_____________________________________________________________________________
...
$enr = mysqli_fetch_assoc($R) or exit();	// Récupération de la sélection
...
function fpl_verifZones() {
	...
	if (!preg_match('/^\S./', $_POST['anNom'])) {
		$erreurs['anNom'] = 'La zone Pseudo ne doit pas commencer par un espace ou être vide.';
	}
